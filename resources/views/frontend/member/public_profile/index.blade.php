...
@section('opengraph')
    <meta property="og:image" content="{{ uploaded_asset($user->photo) }}"/>
    <meta property="og:type" content="website">
    <meta property="og:title" content="{{ $user->first_name.' '.$user->last_name }}">
    <meta property="og:image:type" content="{{ uploaded_asset($user->photo) }}" />
...
#mypImg{
    cursor: pointer;
    /*background-image: url('{{ uploaded_asset(get_setting('header_logo')) }}');*/
}
                    ...
                    <div class="overflow-hidden rounded shadow-lg mb-4 bg-white d-none d-xl-block">
                      ...
                      @endphp
                        <img 
                            ...
                            src="{{ uploaded_asset($user->photo) }}" id="mypImg"
                            @else
                            ...
                            alt="Member"
                        >
                      <p class="text-center"><img class="pic_caption" src="{{ uploaded_asset(get_setting('header_logo')) }}"></p>
                    </div>
       ...
       img01.className = "modal-content";
                    ...
                    <div class="border rounded">
                        <a href="{{ get_setting('public_profile_page_banner_link') }}" class="text-reset">
                            <img src="{{ uploaded_asset(get_setting('public_profile_page_banner')) }}" class="img-fluid w-100" alt="terasaath">
                        </a>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        ...
                                                        <!-- <tr>
                                                            <td class="py-1 fw-600">{{ translate('Alternate Phone') }}
                                                            </td>
                                                            <td class="py-1">
                                                                {{ !empty($user->member->alphone) ? $user->member->alphone : ""  }}
                                                            </td>
                                                        </tr> -->
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="col-md-6">
                                            <div class="border p-3">
                                              @if($user->phone != null)
                                                ...
                                                <div class="d-flex mb-3">
                                                    <i class="las la-phone text-primary la-2x mr-3"></i>
                                                    <div>
                                                        <div class="fs-15 fw-600 mb-1">{{ translate('Alternate Number') }}
                                                        </div>
                                                        @if(empty($view_contact))
                                                        <div class="fw-400">+xx xxx xxx xxx</div>
                                                        @else
                                                        <div class="fw-400">{{ $user->member->alphone  }}</div>
                                                        @endif
                                                    </div>
                                                </div>
                                                @endif
                                                ...
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="fw-400">+xx xxx xxx xxx</div>
                                                        @else
                                                       <div class="fw-400"> {{ !empty($user->families->father) ? $user->families->father_number : "" }}</div>
                                                        @endif
                                            ...
                                            <div class="d-flex mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="fw-400">+xx xxx xxx xxx</div>
                                                        @else
                                                       <div class="fw-400"> {{ !empty($user->families->mother) ? $user->families->mother_number : "" }}</div>
                                                        @endif
                                            ...
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th class="py-1">{{translate('Veg/Non-Veg')}}</th>
