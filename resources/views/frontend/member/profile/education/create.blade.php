<form action="{{ route('education.store') }}" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row" style="display: none">
            ...
            <div class="col-md-9">
                <input type="number" value="1" name="education_start" class="form-control" placeholder="{{translate('Start')}}" required>
            </div>
        </div>
        <div class="form-group row" style="display: none">
            <label class="col-md-3 col-form-label">{{translate('End')}}</label>
            <div class="col-md-9">
                <input type="number" value="1" name="education_end"  placeholder="{{ translate('End') }}" class="form-control" required>
            </div>
        </div>
    </div>
