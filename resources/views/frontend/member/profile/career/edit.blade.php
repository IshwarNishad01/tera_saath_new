<form action="{{ route('career.update', $career->id) }}" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" name="package" value="{{$career->package}}"  placeholder="{{ translate('salary') }}" class="form-control" required>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="number" name="career_end" value="{{$career->end}}"  placeholder="{{ translate('End') }}" class="form-control" required>
            </div>
        </div>
    </div>
