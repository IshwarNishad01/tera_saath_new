    ...
    <div class="card-body">
        ...
        <form action="{{ route('member.basic_info_update', $member->id) }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <label for="first_name" >{{translate('Alternate Number')}}
                        <span class="text-danger">*</span>
                    </label>
                    <input type="text" name="contact_number" value="{{ $member->member->alphone }}" class="form-control" placeholder="{{translate('Alternate Number')}}" >
                </div>
            </div>
