        ...
        <form action="{{ route('partner_expectations.update', $member->id) }}" method="POST">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="number" name="partner_height" value="{{ !empty($member->partner_expectations->height) ? $member->partner_expectations->height : "" }}" step=".1" placeholder="{{ translate('Height') }}" class="form-control" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="partner_weight" value="{{ !empty($member->partner_expectations->weight) ? $member->partner_expectations->weight : "" }}" class="form-control" placeholder="{{translate('Weight')}}" required>
