...
<head>
 ...
 -->
    ...
    <!-- Icons font CSS-->
    <link href="{{ static_asset('assets/vendor_matrimonial/mdi-font/css/material-design-iconic-font.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ static_asset('assets/vendor_matrimonial/font-awesome-4.7/css/font-awesome.min.css') }}" rel="stylesheet" media="all">
    <!-- Font special for pages-->
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i" rel="stylesheet">

    <!-- Vendor CSS-->
    <link href="{{ static_asset('assets/vendor_matrimonial/select2/select2.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ static_asset('assets/vendor_matrimonial/datepicker/daterangepicker.css') }}" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="{{ static_asset('assets/css_matrimonial/main.css') }}" rel="stylesheet" media="all">
</head>
...
<div class="wrapper1">
    <!-- <div class="round">
                ...
                <div class="card-body">
                    ...
                    <div class="logo"><img class="logo_mobile" src="{{ static_asset('assets/img_matrimonial/tera_saath_logo.png') }}">      <br>
    ...
    <!-- Jquery JS-->
    <script src="{{ static_asset('assets/vendor_matrimonial/jquery/jquery.min.js') }}"></script>
    <!-- Vendor JS-->
    <script src="{{ static_asset('assets/vendor_matrimonial/select2/select2.min.js') }}"></script>
    <script src="{{ static_asset('assets/vendor_matrimonial/datepicker/moment.min.js') }}"></script>
    <script src="{{ static_asset('assets/vendor_matrimonial/datepicker/daterangepicker.js') }}"></script>

    <!-- Main JS-->
    <script src="{{ static_asset('assets/js_matrimonial/global.js') }}"></script>
    <script>
