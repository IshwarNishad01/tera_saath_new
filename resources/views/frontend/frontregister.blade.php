					...
					<div class="card-body">
				        ...
				        <div class="form-group text-right">
							...
							<!-- <div class="row">
								<div class="col-lg-12">
									<div class="form-group mb-3">
										<label class="form-label" for="password">{{ translate('Alternate Mobile Number') }}</label>
										<input type="phone" class="form-control @error('phone') is-invalid @enderror" name="almobile" id="password" placeholder="201-555-0123"  required>
