...
<footer class="aiz-footer fs-13 mt-auto text-white fw-400 pt-5">
    <div class="container">
                ...
                <div>
                    <ul class="list-unstyled">
                        @foreach (json_decode( get_setting('widget_one_labels'), true) as $key => $value)
                            <li class="my-3"><a href="{{ json_decode( get_setting('widget_one_links'), true)[$key] }}" class="text-reset opacity-60">{{ $value }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
        ...
        {{-- <p style="color: #f96161; text-align: center;"><b>Our office :- Mumbai, Bangalore, Pune, Delhi</b></p> --}}
