                  ...
                  <form action="{{ route('settings.update') }}" method="POST" >
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              ...
                              <input type="text" name="member_code_prifix" class="form-control" value="{{ get_setting('member_code_prifix') }}">
                          </div>
                      </div>
          ...
          <div class="card">
              ...
              <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-8">
                            <label class="col-from-label">{{translate('Only Premium Member Can See Other Members Full Profile.')}}
                                <i>
                                    <code>({{ translate('If you disable this, everyone will be able to see the members full profile.') }})</code>
                                </i>
                            </label>
                        </div>
                        <div class="col-sm-4">
