    ...
    <form action="{{ route('partner_expectations.update', $member->id) }}" method="POST">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <input type="text" name="partner_height" value="{{ !empty($member->partner_expectations->height) ? $member->partner_expectations->height : "" }}" placeholder="{{ translate('Height') }}" class="form-control" required>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="partner_weight" value="{{ !empty($member->partner_expectations->weight) ? $member->partner_expectations->weight : "" }}" class="form-control" placeholder="{{translate('Weight')}}" required>
