        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <tr>
                    ...
                    <th>{{translate('Alter Phone Number')}}</th>
                    <td>{{ $member->contact_number }}</td>
                    <!-- <td>{{ $member->member->alphone }}</td> -->
                </tr>
                </table>
            </div>
        </div>
              ...
              <div class="card-body">
                  <table class="table">
                      <tr>
                          ...
                          <td>
                              @if(!empty($member->member->mothere_tongue))
                                  {{ \App\Models\MemberLanguage::where('id',$member->member->mothere_tongue)->first()->name }}
                              @endif
                          </td>
                            ...
                            @if(!empty($member->member->known_languages))
                              @foreach (json_decode($member->member->known_languages) as $key => $value)
                                  <span class="badge badge-inline badge-info">
                                      {{ \App\Models\MemberLanguage::where('id',$value)->first()->name }}
                                  </span>
                              @endforeach
                            @endif
                          </td>
                  ...
                  <table class="table">
                        <tr>
                          ...
                          <td>{{ !empty($member->families->father) ? $member->families->father : "" }}</td>
                           ...
                           <th>{{translate('Father Description')}}</th>
                          <td>{{ !empty($member->families->fatherdesc) ? $member->families->fatherdesc : "" }}</td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <th>{{translate('Mother Description')}}</th>
                          <td>{{ !empty($member->families->motherdesc) ? $member->families->motherdesc : "" }}</td>
                      </tr>
                      <tr>
                          <th>{{translate('Sibling')}}</th>
                          <td>{{ !empty($member->families->sibling) ? $member->families->sibling : "" }}</td>

                          <th>{{translate('Sibling Description')}}</th>
                          <td>{{ !empty($member->families->sibling_desc) ? $member->families->sibling_desc : "" }}</td>
                      </tr>

                      <tr>
                          <th>{{translate('Father Contact Number')}}</th>
                          <td>{{ !empty($member->families->father_number) ? $member->families->father_number : "" }}</td>

                          <th>{{translate('Mother Contact Number')}}</th>
                          <td>{{ !empty($member->families->mother_number) ? $member->families->mother_number : "" }}</td>
                      </tr>
                  </table>
              </div>
          </div>
