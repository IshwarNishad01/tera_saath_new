                        ...
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                               ...
                               <!--  @if(get_setting('member_personal_attitude_and_behavior_section') == 'on')
                                <a class="nav-link" id="v-pills-tab-9" data-toggle="pill" href="#attitudes_behavior" role="tab" aria-controls="v-pills-settings" aria-selected="false">{{translate('Personal Attitude & Behaviour')}}</a>
                                @endif
