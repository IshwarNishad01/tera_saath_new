...
<div class="card-body">
    <form action="{{ route('spiritual_backgrounds.update', $member->id) }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <label for="ethnicity">{{translate('Gotra')}}</label>
        ...
        <!-- <div class="form-group row">
            ...
            <div class="col-md-6">
                <label for="horoscope">{{translate('Horoscope')}}</label>
                <input type="text" name="horoscope" value="{{!empty($member->spiritual_backgrounds->horoscope) ? $member->spiritual_backgrounds->horoscope : "" }}" class="form-control" placeholder="{{translate('Horoscope')}}">
                @error('horoscope')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            </div>
