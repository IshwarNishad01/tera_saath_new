    ...
    <form action="{{ route('partner_expectations.update', $member->id) }}" method="POST">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <input type="text" name="partner_height" value="{{ !empty($member->partner_expectations->height) ? $member->partner_expectations->height : "" }}" placeholder="{{ translate('Height') }}" class="form-control">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="partner_weight" value="{{ !empty($member->partner_expectations->weight) ? $member->partner_expectations->weight : "" }}" class="form-control" placeholder="{{translate('Weight')}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="partner_children_acceptable" value="{{ !empty($member->partner_expectations->children_acceptable) ? $member->partner_expectations->children_acceptable : "" }}" class="form-control" placeholder="{{translate('Children Acceptable')}}">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <input type="text" name="smoking_acceptable" value="{{ !empty($member->partner_expectations->smoking_acceptable) ? $member->partner_expectations->smoking_acceptable : "" }}" class="form-control" placeholder="{{translate('Smoking Acceptable')}}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="drinking_acceptable" value="{{ !empty($member->partner_expectations->drinking_acceptable) ? $member->partner_expectations->drinking_acceptable : "" }}" class="form-control" placeholder="{{translate('Drinking Acceptable')}}">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <input type="text" name="partner_diet" value="{{ !empty($member->partner_expectations->diet) ? $member->partner_expectations->diet : "" }}" class="form-control" placeholder="{{translate('Diet')}}">
                @error('partner_diet')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="partner_manglik" value="{{ !empty($member->partner_expectations->manglik) ? $member->partner_expectations->manglik : "" }}" class="form-control" placeholder="{{translate('Manglik')}}">
