                ...
                <div class="card-body">
                    <form action="{{ route('packages.update', $package->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="actual_price"  value="{{$package->actual_price}}" class="form-control" placeholder="Actual Price" required>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{translate('Additional Features')}}</label>
                            <div class="col-md-9">
                                <input type="text" name="additional" value="{{ $package->additional }}" class="form-control" placeholder="{{translate('Additional Features')}}" >
                                @error('additional')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
