  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" id="confirm_button"><?php echo e(translate('Confirm')); ?></button>
        </div>
      </div>
  </div>
</div>
<?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/modals/confirm_modal.blade.php ENDPATH**/ ?>