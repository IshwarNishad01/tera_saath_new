...
<?php $__env->startSection('opengraph'); ?>
    <meta property="og:image" content="<?php echo e(uploaded_asset($user->photo)); ?>"/>
    <meta property="og:type" content="website">
    <meta property="og:title" content="<?php echo e($user->first_name.' '.$user->last_name); ?>">
    <meta property="og:image:type" content="<?php echo e(uploaded_asset($user->photo)); ?>" />
                ...
                <div class="px-3 row align-items-center">
                    <div class="col-md-8 col-xxl-9">
                        <h1 class="fs-24 fw-600">
                          ...
                          <?php $present_address = \App\Models\Address::where('user_id',$user->id)->where('type','present')->first(); ?>
                        ...
                        <div class="fs-12">
                            ...
                            <span class="ml-2"><?php echo e($user->code); ?></span>
                        </div>
                        ...
                        <table class="w-100">
                            <tbody>
                                <tr>
                                    <td width="50%">
                                        <?php echo e(!empty($user->member->birthday) ? \Carbon\Carbon::parse($user->member->birthday)->age : ""); ?>

                                        <?php echo e(translate('yrs')); ?>

                                        <?php echo e(!empty($user->physical_attributes->height) ? ', '.$user->physical_attributes->height : ""); ?>

                                    </td>
                                    <td width="50%">
                                        <?php echo e(!empty($user->member->marital_status->name) ? $user->member->marital_status->name : ""); ?>

                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?php echo e(!empty($user->spiritual_backgrounds->religion->name) ? $user->spiritual_backgrounds->religion->name : ""); ?>

                                        <?php echo e(!empty($user->spiritual_backgrounds->caste->name) ? ', '.$user->spiritual_backgrounds->caste->name : ""); ?>

                                    </td>
                                    <td>
                                        <?php echo e(translate('Lives in')); ?>

                                        <?php echo e(!empty($present_address->country->name) ? $present_address->country->name : ""); ?>
                    ...
                    <div class="col-md-4 col-xxl-3">
                        ...
                        <div class="py-4 text-center border-md-left border-gray-600">
                            <?php if((empty($do_expressed_interest) && empty($received_expressed_interest)) || (!empty($received_expressed_interest && $received_expressed_interest->status == 0)  )): ?>
                                <div class="fs-18 fw-500"><?php echo e(translate('Like this Profile ?')); ?></div>
                            <?php endif; ?>
                            <a
                                ...
                                <span id="interest_id_<?php echo e($user->id); ?>" class="d-block fs-13 <?php echo e($interest_class); ?>">
...
/*            display: none  */
                             ...
                             <a href="https://wa.me/?text= *<?php echo e($user->first_name.' '.$user->last_name); ?>* %0a %0a(Member ID : <?php echo e($user->code); ?>) %0a is Registered on our website. Now you can also Search your partner and register yourself in Tera Saath Community Matrimonial Wesite.%0a Click here for view our full profile.%0a Link: %0a https://terasaath.in/member-profile/<?php echo e($user->id); ?>" data-action="share/whatsapp/share"  
        target="_blank" class="btn btn-success whatsapp_link"> Share Profile </a>   
                        </div>
                    </div>
                </div>
                <div class="mt-4">
                    <div class="nav nav-tabs aiz-nav-tabs bottom-bordered active-white border-0">
                        <a class="text-black-50 d-inline-block fw-600 fs-15 px-3 py-2 active" data-toggle="tab" href="#profile"><?php echo e(translate('Detailed Profile')); ?></a>
                        <?php if(get_setting('member_partner_expectation_section') == 'on'): ?>
                            <a class="text-black-50 d-inline-block fw-600 fs-15 px-3 py-2" data-toggle="tab" href="#preference"><?php echo e(translate('Partner Preference')); ?></a>
                        <?php endif; ?>
                        <a class="text-black-50 d-inline-block fw-600 fs-15 px-3 py-2" data-toggle="tab" href="#gallery"><?php echo e(translate('Photo Gallery')); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
#mypImg{
    cursor: pointer;
    /*background-image: url('<?php echo e(uploaded_asset(get_setting('header_logo'))); ?>');*/
}
                    ...
                    <div class="overflow-hidden rounded shadow-lg mb-4 bg-white d-none d-xl-block">
                      ...
                      ?>
                        <img 
                            ...
                            src="<?php echo e(uploaded_asset($user->photo)); ?>" id="mypImg"
                            <?php else: ?>
                            ...
                            alt="Member"
                        >
                      <p class="text-center"><img class="pic_caption" src="<?php echo e(uploaded_asset(get_setting('header_logo'))); ?>"></p>
                    </div>
                    <div id="myModal" class="modal">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <img class="modal-content" id="img01" alt="Tera saath">
                    </div>
...
var img = document.getElementById('mypImg');
    ...
    setTimeout(function() {
       ...
       img01.className = "modal-content";
                    ...
                    <div class="mb-4 p-4 border rounded border-gray-200 d-none d-xl-block">
                        <div class="fs-12">
                            <span class="opacity-60"><?php echo e(translate('Member ID: ')); ?></span>
                            <span class="ml-1 text-primary"><?php echo e($user->code); ?></span>
                        </div>
                        <h2 class="fs-20 fw-500 mb-4"><?php echo e($user->first_name.' '.$user->last_name); ?></h2>
                        ...
                        <div class="mb-2">
                            ...
                            ?>
                            <a href="avascript:void(0);" id="shortlist_a_id_<?php echo e($user->id); ?>"
                                ...
                                <span id="shortlist_id_<?php echo e($user->id); ?>"><?php echo e($shortlist_text); ?></span>
                            </a>
                        </div>
                        <div class="row gutters-5">
                            <div class="col">
                                <a href="avascript:void(0);" onclick="ignore_member(<?php echo e($user->id); ?>)" class="btn btn-block btn-primary text-left">
                                    <i class="las la-ban d-block la-2x"></i>
                                    <?php echo e(translate('Ignore')); ?>
                            ...
                            <div class="col">
                                ...
                                ?>
                                <a href="avascript:void(0);" id="report_a_id_<?php echo e($user->id); ?>"
                                  <?php if($report_onclick == 1): ?>
                                    onclick="report_member(<?php echo e($user->id); ?>)"
                                  <?php endif; ?>
                                    class="btn btn-block btn-primary text-left">
                                    <i class="las la-info-circle d-block la-2x"></i>
                                    <span id="report_id_<?php echo e($user->id); ?>"><?php echo e($report_text); ?>
                    ...
                    <?php if(Auth::user()->member->auto_profile_match == 1): ?>
                      <div class="mb-4">
                          <div class="d-flex justify-content-between">
                              <h3 class="fs-18 mb-3"><?php echo e(translate('Similar Profiles')); ?></h3>
                              <!-- <a href="" class="mt-1"><?php echo e(translate('See More')); ?></a> -->
                          </div>
                          <div>
                              <?php $__currentLoopData = $similar_profiles->shuffle()->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $similar_profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="border rounded">
                        <a href="<?php echo e(get_setting('public_profile_page_banner_link')); ?>" class="text-reset">
                            <img src="<?php echo e(uploaded_asset(get_setting('public_profile_page_banner'))); ?>" class="img-fluid w-100" alt="terasaath">
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-xl-8 offset-xxl-1">
                ...
                <div class="tab-content">
                        ...
                        <svg style="height: 0;width: 0;opacity: 0;visibility: hidden;">
                            <defs>
                                <linearGradient id="primary-gradient" x1="0.5" x2="0.5" y2="1"
                                    ...
                                    <stop offset="0" stop-color="<?php echo e(get_setting('secondary_color', '#FD655B')); ?>" />
                                    <stop offset="1" stop-color="<?php echo e(get_setting('base_color', '#FD655B')); ?>" />
                                </linearGradient>
                            </defs>
                        </svg>
                        <div class="accordion aiz-timeline-accordion" id="profile-accordion">
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span
                                            class="fs-18 fw-600 d-block"><?php echo e(translate('About ')); ?><?php echo e($user->first_name.' '.$user->last_name); ?></span>
                                        <span class="fs-11 fw-400">
                                            <span><?php echo e(translate('Member ID: ')); ?> <?php echo e($user->code); ?></span>
                                            <span class="mx-2">|</span>
                                            <span><?php echo e(translate('On Behalf:')); ?> <?php echo e($user->member->on_behalves->name); ?></span>
                                        </span>
                                    </div>
                                </div>
                                <div id="about" class="collapse show accordion-body ml-3 ml-md-5 pl-25px lh-1-8"
                                    data-parent="#profile-accordion">
                                    <?php echo e($user->member->introduction); ?>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Basic Information')); ?></span>
                                    </div>
                                </div>
                                <div id="basic-info" class="ml-3 ml-md-5 pl-25px">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-sm-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('First Name')); ?></td>
                                                            <td class="py-1"><?php echo e($user->first_name); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Gender')); ?></td>
                                                            <td class="py-1">
                                                                <?php if($user->member->gender == 1): ?>
                                                                <?php echo e(translate('Male')); ?>

                                                                <?php elseif($user->member->gender == 2): ?>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Age')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->member->birthday) ? \Carbon\Carbon::parse($user->member->birthday)->age : ""); ?>
                                                        ...
                                                        <tr>
                                                            <th class="py-1 fw-600"><?php echo e(translate('Religion')); ?></th>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->spiritual_backgrounds->religion->name) ? $user->spiritual_backgrounds->religion->name : ""); ?>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('First Language')); ?>

                                                            </td>
                                                            <td class="py-1">
                                                                <?php if(!empty($user->member->mothere_tongue)): ?>
                                                                <?php echo e(optional(\App\Models\MemberLanguage::where('id',$user->member->mothere_tongue)->first())->name); ?>

                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('No. of  Children')); ?>

                                                            </td>
                                                            <td class="py-1"><?php echo e($user->member->children); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Last Name')); ?></td>
                                                            <td class="py-1"><?php echo e($user->last_name); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Height')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->physical_attributes->height) ? $user->physical_attributes->height : ""); ?>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Date of Birth')); ?>

                                                            </td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->member->birthday) ? date('d/m/Y',strtotime($user->member->birthday)) : ""); ?>

                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1 fw-600"><?php echo e(translate('Caste')); ?></th>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->spiritual_backgrounds->caste->name) ? $user->spiritual_backgrounds->caste->name : ""); ?>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Marital Status')); ?>
                                                        ...
                                                        <!-- <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Alternate Phone')); ?>

                                                            </td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->member->alphone) ? $user->member->alphone : ""); ?>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Present Address')); ?></span>
                                    </div>
                                </div>
                                <div id="present-address" class="ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="border p-3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600">
                                                                ...
                                                                <span><?php echo e(translate('State')); ?></span>
                                                            </td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($present_address->state->name) ? $present_address->state->name : ""); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="py-1">
                                                                <?php echo e(!empty($present_address->city->name) ? $present_address->city->name : ""); ?>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600">
                                                                ...
                                                                <span><?php echo e(translate('Postal Code')); ?></span>
                                                            </td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($present_address->postal_code) ? $present_address->postal_code : ""); ?>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Contact Details')); ?></span>
                                    </div>
                                </div>
                                <div id="contact-details" class="ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="border p-3">
                                              <?php if($user->phone != null): ?>
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div>
                                                        <div class="fs-15 fw-600 mb-1"><?php echo e(translate('Contact Number')); ?>

                                                        </div>
                                                        <?php if(empty($view_contact)): ?>
                                                        <div class="fw-400">+xx xxx xxx xxx</div>
                                                        <?php else: ?>
                                                        <div class="fw-400"><?php echo e($user->phone); ?></div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <?php endif; ?>
                                                ...
                                                <div class="d-flex mb-3">
                                                    <i class="las la-phone text-primary la-2x mr-3"></i>
                                                    <div>
                                                        <div class="fs-15 fw-600 mb-1"><?php echo e(translate('Alternate Number')); ?>

                                                        </div>
                                                        <?php if(empty($view_contact)): ?>
                                                        <div class="fw-400">+xx xxx xxx xxx</div>
                                                        <?php else: ?>
                                                        <div class="fw-400"><?php echo e($user->member->alphone); ?></div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <?php endif; ?>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <div class="fs-15 fw-600 mb-1"><?php echo e(translate('Email ID')); ?></div>
                                                        <?php if(empty($view_contact)): ?>
                                                        <div class="fw-400">xxxxx@xxx.xx</div>
                                                        <?php else: ?>
                                                        <div class="fw-400"><?php echo e($user->email); ?></div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <?php endif; ?>
                                                ...
                                                <div class="d-flex mb-3">
                                                    <i class="las la-phone text-primary la-2x mr-3"></i>
                                                    <div>
                                                        <div class="fs-15 fw-600 mb-1">Father's Contact Number
                                                        </div>
                                                        <?php if(empty($view_contact)): ?>
                                                        <div class="fw-400">+xx xxx xxx xxx</div>
                                                        <?php else: ?>
                                                       <div class="fw-400"> <?php echo e(!empty($user->families->father) ? $user->families->father_number : ""); ?></div>
                                                        <?php endif; ?>
                                            ...
                                            <div class="d-flex mb-3">
                                                    <i class="las la-phone text-primary la-2x mr-3"></i>
                                                    <div>
                                                        <div class="fs-15 fw-600 mb-1">Mothers's Contact Number
                                                        </div>
                                                       
                                                        <?php if(empty($view_contact)): ?>
                                                        <div class="fw-400">+xx xxx xxx xxx</div>
                                                        <?php else: ?>
                                                       <div class="fw-400"> <?php echo e(!empty($user->families->mother) ? $user->families->mother_number : ""); ?></div>
                                                        <?php endif; ?>
                                                ...
                                                <?php if(empty($view_contact)): ?>
                                                <a onclick="view_contact(<?php echo e($user->id); ?>)"
                                                    class="btn btn-block bg-primary text-white mt-2 view_contact">
                                                    <i class="las la-phone"></i> <?php echo e(translate('View Contact Info')); ?>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Education')); ?></span>
                                    </div>
                                </div>
                                <div id="education" class="ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="badge badge-inline badge-success"><?php echo e(translate('Running')); ?></span>
                                                    <?php else: ?>
                                                    <span
                                                        class="badge badge-inline badge-danger"><?php echo e(translate('Completed')); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Career')); ?></span>
                                    </div>
                                </div>
                                <div id="career" class="ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="badge badge-inline badge-success"><?php echo e(translate('Active')); ?></span>
                                                    <?php else: ?>
                                                    <span
                                                        class="badge badge-inline badge-danger"><?php echo e(translate('Deactive')); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Physical Attributes')); ?></span>
                                    </div>
                                </div>
                                <div id="physical-attributes" class="ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-sm-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Eye Color')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->physical_attributes->eye_color) ? $user->physical_attributes->eye_color : ""); ?>

                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Complexion')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->physical_attributes->complexion) ? $user->physical_attributes->complexion : ""); ?>

                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Body Type')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->physical_attributes->body_type) ? $user->physical_attributes->body_type : ""); ?>

                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Disability')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->physical_attributes->disability) ? $user->physical_attributes->disability : ""); ?>
                                            ...
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Weight')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->physical_attributes->weight) ? $user->physical_attributes->weight : ""); ?>

                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Hair Color')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->physical_attributes->hair_color) ? $user->physical_attributes->hair_color : ""); ?>

                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Blood Group')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->physical_attributes->blood_group) ? $user->physical_attributes->blood_group : ""); ?>

                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600"><?php echo e(translate('Body Art')); ?></td>
                                                            <td class="py-1">
                                                                <?php echo e(!empty($user->physical_attributes->body_art) ? $user->physical_attributes->body_art : ""); ?>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Language')); ?></span>
                                    </div>
                                </div>
                                <div id="language" class="ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="border p-3">
                                                <table class="w-100">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="py-1">
                                                                <?php if(!empty($user->member->known_languages)): ?>
                                                                    <?php $__currentLoopData = json_decode($user->member->known_languages); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php echo e(optional(\App\Models\MemberLanguage::where('id',$value)->first())->name); ?>,
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Hobbies & Interest')); ?></span>
                                    </div>
                                </div>
                                <div id="hobby" class="ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tr>
                                                        <th class="py-1"><?php echo e(translate('Hobbies')); ?></th>
                                                        <td class="py-1"><?php echo e(!empty($user->hobbies->hobbies) ? $user->hobbies->hobbies : ""); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="py-1"><?php echo e(translate('Music')); ?></th>
                                                        <td class="py-1"><?php echo e(!empty($user->hobbies->music) ? $user->hobbies->music : ""); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="py-1"><?php echo e(translate('Movies')); ?></th>
                                                        <td class="py-1"><?php echo e(!empty($user->hobbies->movies) ? $user->hobbies->movies : ""); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="py-1"><?php echo e(translate('Sports')); ?></th>
                                                        <td class="py-1"><?php echo e(!empty($user->hobbies->sports) ? $user->hobbies->sports : ""); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="py-1"><?php echo e(translate('Cuisines')); ?></th>
                                                        <td class="py-1"><?php echo e(!empty($user->hobbies->cuisines) ? $user->hobbies->cuisines : ""); ?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Interests')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->hobbies->interests) ? $user->hobbies->interests : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Books')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->hobbies->books) ? $user->hobbies->books : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('TV Shows')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->hobbies->tv_shows) ? $user->hobbies->tv_shows : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Fitness Activities')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->hobbies->fitness_activities) ? $user->hobbies->fitness_activities : ""); ?>

                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Dress Styles')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->hobbies->dress_styles) ? $user->hobbies->dress_styles : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            <!-- <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Personal Attitude & Behavior')); ?></span>
                                    </div>
                                </div>
                                <div id="personal-attitude" class="ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Affection')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->attitude->affection) ? $user->attitude->affection : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Political Views')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->attitude->political_views) ? $user->attitude->political_views : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Humor')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->attitude->humor) ? $user->attitude->humor : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Religious Service')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->attitude->religious_service) ? $user->attitude->religious_service : ""); ?>
                            ...
                            <!-- <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#residency-info">
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Residency Information')); ?></span>
                                    </div>
                                </div>
                                <div id="residency-info" class="ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Birth Country')); ?></th>
                                                            <td class="py-1">
                                                                <?php if(!empty($user->recidency->birth_country_id)): ?>
                                                                <?php echo e(App\Models\Country::where('id',$user->recidency->birth_country_id)->first()->name); ?>

                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Growup Country')); ?></th>
                                                            <td class="py-1">
                                                                <?php if(!empty($user->recidency->growup_country_id)): ?>
                                                                <?php echo e(App\Models\Country::where('id',$user->recidency->growup_country_id)->first()->name); ?>
                                            ...
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Recidency Country')); ?></th>
                                                            <td class="py-1">
                                                                <?php if(!empty($user->recidency->recidency_country_id)): ?>
                                                                <?php echo e(App\Models\Country::where('id',$user->recidency->recidency_country_id)->first()->name); ?>

                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Immigration Status')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->recidency->immigration_status) ? $user->recidency->immigration_status : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#spiritual-social">
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Spiritual & Social Background')); ?></span>
                                    </div>
                                </div>
                                <div id="spiritual-social" class="ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Religion')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->spiritual_backgrounds->religion->name) ? $user->spiritual_backgrounds->religion->name : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Sub Caste')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->spiritual_backgrounds->sub_caste->name) ? $user->spiritual_backgrounds->sub_caste->name : ""); ?></td>
                                                        </tr>
                                                        <!-- <tr>
                                                            <th class="py-1"><?php echo e(translate('Personal Value')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->spiritual_backgrounds->personal_value) ? $user->spiritual_backgrounds->personal_value : ""); ?></td>
                                                        </tr> -->
                                                        <!-- <tr>
                                                            <th class="py-1"><?php echo e(translate('Community Value')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->spiritual_backgrounds->community_value) ? $user->spiritual_backgrounds->community_value : ""); ?></td>
                                                        </tr> -->
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Family Value')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->spiritual_backgrounds->family_value->name) ? $user->spiritual_backgrounds->family_value->name : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Caste')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->spiritual_backgrounds->caste->name) ? $user->spiritual_backgrounds->caste->name : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Ethnicity')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->spiritual_backgrounds->ethnicity) ? $user->spiritual_backgrounds->ethnicity : ""); ?></td>
                                                        </tr>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#life-style">
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Life Style')); ?></span>
                                    </div>
                                </div>
                                <div id="life-style" class="ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        <!-- <tr>
                                                            <th class="py-1"><?php echo e(translate('Diet')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->lifestyles->diet) ? $user->lifestyles->diet : ""); ?></td>
                                                        </tr> -->
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Veg/Non-Veg')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->lifestyles->smoke) ? $user->lifestyles->smoke : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <!-- <tr>
                                                            <th class="py-1"><?php echo e(translate('Drink')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->lifestyles->drink) ? $user->lifestyles->drink : ""); ?></td>
                                                        </tr> -->
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Living With')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->lifestyles->living_with) ? $user->lifestyles->living_with : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#astronomic">
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Astronomic Information')); ?></span>
                                    </div>
                                </div>
                                <div id="astronomic" class="ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        <!-- <tr>
                                                            <th class="py-1"><?php echo e(translate('Sun Sign')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->astrologies->sun_sign) ? $user->astrologies->sun_sign : ""); ?></td>
                                                        </tr> -->
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Time Of Birth')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->astrologies->time_of_birth) ? $user->astrologies->time_of_birth : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <!-- <tr>
                                                            <th class="py-1"><?php echo e(translate('Moon Sign')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->astrologies->moon_sign) ? $user->astrologies->moon_sign : ""); ?></td>
                                                        </tr> -->
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('City Of Birth')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->astrologies->city_of_birth) ? $user->astrologies->city_of_birth : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#permanent-address">
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Permanent Address')); ?></span>
                                    </div>
                                </div>
                                <div id="permanent-address" class="ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">

                                    <?php $permanent_address = \App\Models\Address::where('user_id',$user->id)->where('type','permanent')->first(); ?>
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('City')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($permanent_address->city->name) ? $permanent_address->city->name : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Country')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($permanent_address->country->name) ? $permanent_address->country->name : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('State')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($permanent_address->state->name) ? $permanent_address->state->name : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Postal Code')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($permanent_address->postal_code) ? $permanent_address->postal_code : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#family-info">
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block"><?php echo e(translate('Family Information')); ?></span>
                                    </div>
                                </div>
                                <div id="family-info" class="ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Father')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->families->father) ? $user->families->father : ""); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Sibling')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->families->sibling) ? $user->families->sibling : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1"><?php echo e(translate('Mother')); ?></th>
                                                            <td class="py-1"><?php echo e(!empty($user->families->mother) ? $user->families->mother : ""); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                    ...
                    <div class="tab-pane fade" id="preference">
                        <!-- Partner Expectation -->
                        <h2 class="text-primary fs-24 mb-5 pb-4 border-bottom"><?php echo e(translate('Partner Expectation')); ?></h2>
                        <div class="">
                              <table class="table table-responsive">
                                  <tr>
                                      <th><?php echo e(translate('General')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->general) ? $user->partner_expectations->general : ""); ?>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo e(!empty($user->partner_expectations->height) ? $user->partner_expectations->height : ""); ?>

                                      </td>

                                      <th><?php echo e(translate('weight')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->weight) ? $user->partner_expectations->weight : ""); ?>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo e(!empty($user->partner_expectations->marital_status->name) ? $user->partner_expectations->marital_status->name : ""); ?>

                                      </td>

                                      <th><?php echo e(translate('Children Acceptable')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->children_acceptable) ? $user->partner_expectations->children_acceptable : ""); ?>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo e(!empty($user->partner_expectations->religion->name) ? $user->partner_expectations->religion->name : ""); ?>

                                      </td>

                                      <th><?php echo e(translate('Caste')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->caste->name) ? $user->partner_expectations->caste->name : ""); ?>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo e(!empty($user->partner_expectations->sub_caste->name) ? $user->partner_expectations->sub_caste->name : ""); ?>

                                      </td>

                                      <th><?php echo e(translate('Language')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->language->name) ? $user->partner_expectations->language->name : ""); ?>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo e(!empty($user->partner_expectations->education) ? $user->partner_expectations->education : ""); ?>

                                      </td>

                                      <th><?php echo e(translate('Profession')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->profession) ? $user->partner_expectations->profession : ""); ?>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo e(!empty($user->partner_expectations->smoking_acceptable) ? $user->partner_expectations->smoking_acceptable : ""); ?>

                                      </td>

                                      <th><?php echo e(translate('Drinking Acceptable')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->drinking_acceptable) ? $user->partner_expectations->drinking_acceptable : ""); ?>

                                      </td>
                                  </tr>
                                  <tr>
                                      <th><?php echo e(translate('Diet')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->diet) ? $user->partner_expectations->diet : ""); ?>

                                      </td>

                                      <th><?php echo e(translate('Body Type')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->body_type) ? $user->partner_expectations->body_type : ""); ?>

                                      </td>
                                  </tr>
                                  <tr>
                                      <th><?php echo e(translate('Personal Value')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->personal_value) ? $user->partner_expectations->personal_value : ""); ?>

                                      </td>

                                      <th><?php echo e(translate('Manglik')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->manglik) ? $user->partner_expectations->manglik : ""); ?>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo e(!empty($user->partner_expectations->family_value->name) ? $user->partner_expectations->family_value->name : ""); ?>

                                      </td>

                                      <th><?php echo e(translate('complexion')); ?></th>
                                      <td><?php echo e(!empty($user->partner_expectations->complexion) ? $user->partner_expectations->complexion : ""); ?>
                    ...
                    <div class="tab-pane fade" id="gallery">
                        <h2 class="text-primary fs-24 mb-5 pb-4 border-bottom"><?php echo e(translate('Gallery')); ?></h2>
                        ...
                        <?php if($galley_image_privacy == 0): ?>
                            <?php $gallery_image_show = 'no'; ?>
                        <?php elseif($galley_image_privacy == 2): ?>
                            <?php if(Auth::user()->membership == 1): ?>
                                <?php $gallery_image_show = 'no'; ?>
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if($gallery_image_show == 'ok'): ?>
                            <div class="card-columns">
                                <?php $galley_images = \App\Models\GalleryImage::where('user_id', $user->id)->latest()->get(); ?>
                                <?php $__currentLoopData = $galley_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galley_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="card hov-overlay">
                                        <img src="<?php echo e(uploaded_asset($galley_image->image)); ?>" class="card-img" alt="<?php echo e(translate('photo')); ?>">
                                        <div class="overlay">
                                            <a target="_blank" href="<?php echo e(uploaded_asset($galley_image->image)); ?>" class="text-white absolute-full d-flex justify-content-center align-items-center" title="View">
...
<script type="text/javascript">
    ...
    // Express Interest
    var remaining_contact_view = <?php echo e(get_remaining_value(Auth::user()->id,'remaining_contact_view')); ?>;
    function view_contact(id)
    {
        if( package_validity == 0 || remaining_contact_view < 1){
          ...
          $("#confirm_modal_title").html("<?php echo e(translate('Confirm Contact View')); ?>");
          $("#confirm_modal_content").html("<p class='fs-14'><?php echo e(translate('Remaining Contact View')); ?>: "+remaining_contact_view+" <?php echo e(translate('Times')); ?></p><small class='text-danger'><?php echo e(translate('**N.B. Viewing This Members Contact Information Will Cost  1 From Your Remaining Contact View**')); ?></small>");
    ...
    function do_contact_view(id){
      ...
      $.post('<?php echo e(route('view_contacts.store')); ?>',
        {
        ...
        function (data) {
          if (data == 1) {
            ...
            AIZ.plugins.notify('success', '<?php echo e(translate('Now You Can See This Members Contact Information')); ?>');
          }
          else {
        ...
        $.post('<?php echo e(route('member.add_to_ignore_list')); ?>',
            ...
            function (data) {
                if (data == 1) {
                    ...
                    window.location.href = "<?php echo e(route('member.listing')); ?>";
                }
                else {
                    AIZ.plugins.notify('danger', '<?php echo e(translate('Something went wrong')); ?>');
                }
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/frontend/member/public_profile/index.blade.php ENDPATH**/ ?>