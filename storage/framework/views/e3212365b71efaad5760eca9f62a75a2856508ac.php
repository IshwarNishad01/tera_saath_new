        ...
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <div class="bg-white rounded shadow-sm p-4 text-left">
                    ...
                    <p class="mb-4 opacity-60"><?php echo e(translate('Enter your phone number and new password and confirm password.')); ?> </p>
                    <form method="POST" action="<?php echo e(route('password.update')); ?>">
                        <?php echo csrf_field(); ?>

                        <div class="form-group">
                            <input id="email" type="number" class="form-control" name="phone" value="<?php echo e($phone ?? old('phone')); ?>" placeholder="<?php echo e(translate('Phone')); ?>" required autofocus>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/auth/passwords/resetphone.blade.php ENDPATH**/ ?>