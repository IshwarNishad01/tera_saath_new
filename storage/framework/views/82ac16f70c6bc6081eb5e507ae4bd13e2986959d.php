                                ...
                                <?php $__currentLoopData = $sms_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sms_template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade show <?php if($sms_template->id == 1): ?> active <?php endif; ?>" id="v-pills-<?php echo e($sms_template->id); ?>" role="tabpanel" aria-labelledby="v-pills-tab-1">
                                        <form action="<?php echo e(route('sms-templates.update', $sms_template->id)); ?>" method="POST">
                                            ...
                                            <?php echo csrf_field(); ?>
                                            <?php if($sms_template->identifier != 'mobile_number_verification' && $sms_template->identifier != 'password_reset'): ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="body" class="form-control aiz-text-editor" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="200" required><?php echo e($sms_template->sms_body); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/addons/otp_systems/configurations/sms_templates.blade.php ENDPATH**/ ?>