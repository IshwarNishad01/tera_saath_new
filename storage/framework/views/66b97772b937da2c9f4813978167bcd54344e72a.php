    ...
    <div class="card-body">
        <form action="<?php echo e(route('member.language_info_update', $member->id)); ?>" method="POST">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <label for="diet"><?php echo e(translate('Mothere Tongue')); ?></label>
...
<?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/frontend/member/profile/language.blade.php ENDPATH**/ ?>