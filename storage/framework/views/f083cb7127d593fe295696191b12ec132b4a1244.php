...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                <label for="horoscope"><?php echo e(translate('Horoscope')); ?></label>
                <input type="text" name="horoscope" value="<?php echo e(!empty($member->spiritual_backgrounds->horoscope) ? $member->spiritual_backgrounds->horoscope : ""); ?>" class="form-control" placeholder="<?php echo e(translate('Horoscope')); ?>">
                <?php $__errorArgs = ['horoscope'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/admin/members/edit/spiritual_backgrounds.blade.php ENDPATH**/ ?>