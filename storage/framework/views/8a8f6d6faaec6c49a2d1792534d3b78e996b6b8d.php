...
<div class="py-4 py-lg-5">
	<div class="container">
		<div class="row">
			<div class="col-xxl-8 col-xl-8 col-md-8 col-lg-8">
				<div class="card">
					<div class="card-body">
...
unset($__errorArgs, $__bag); ?>
							...
							<!-- <div class="row">
								<div class="col-lg-12">
									<div class="form-group mb-3">
										<label class="form-label" for="password"><?php echo e(translate('Alternate Mobile Number')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="almobile" id="password" placeholder="201-555-0123"  required>
...
unset($__errorArgs, $__bag); ?>
			...
			<div class="col-md-4 col-lg-4">
				<center><h1 class="h3 text-primary mb-0"><b>Happy Story</b></h1></center>
				<br>
				<div class="">
					
					 <img src="public/assets/frontimages/frontimg.jpg" style="border-radius: 7px;width: 430px;"><br>
					 <img src="public/assets/frontimages/frontimg1.jpg" style="border-radius: 7px;width: 430px; margin-top: 10px;">
				</div>
			</div>
		</div>
	</div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/frontend/frontregister.blade.php ENDPATH**/ ?>