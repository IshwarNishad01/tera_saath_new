...
<a href="https://api.whatsapp.com/send?phone=+918982680494&text=Hello." class="float_whatsapp" target="_blank">
    ...
    <div class="container">
        ...
        <div class="mb-4">
            ...
            <div class="row opacity-60 no-gutters">
                <?php if(get_setting('footer_address') != null): ?>
                ...
                <?php endif; ?>
                <?php if(get_setting('footer_website') != null): ?>
                <div class="col-xl col-md-6 mb-4">
                    <div class="mb-3 opacity-60">
                ...
                <?php endif; ?>
                <?php if(get_setting('footer_email') != null): ?>
                <div class="col-xl col-md-6 mb-4">
                    <div class="mb-3 opacity-60">
                ...
                <div>
                    <ul class="list-unstyled">
                        <?php $__currentLoopData = json_decode( get_setting('widget_one_labels'), true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="my-3"><a href="<?php echo e(json_decode( get_setting('widget_one_links'), true)[$key]); ?>" class="text-reset opacity-60"><?php echo e($value); ?></a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
...
<?php endif; ?><?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/frontend/inc/footer.blade.php ENDPATH**/ ?>