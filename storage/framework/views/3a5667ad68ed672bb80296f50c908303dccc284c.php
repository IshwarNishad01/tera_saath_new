...
<div class="card-body">
    <form action="<?php echo e(route('physical-attribute.update', $member->id)); ?>" method="POST">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                <label for="height"><?php echo e(translate('Height')); ?></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                <label for="weight"><?php echo e(translate('Weight (in kg)')); ?></label>
                <input type="number" name="weight" value="<?php echo e(!empty($member->physical_attributes->weight) ? $member->physical_attributes->weight : ""); ?>" placeholder="<?php echo e(translate('Weight')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?> -->
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <input type="text" name="body_type" value="<?php echo e(!empty($member->physical_attributes->body_type) ? $member->physical_attributes->body_type : ""); ?>" class="form-control" placeholder="<?php echo e(translate('Body Type')); ?>">
...
<?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/admin/members/edit/physical_attributes.blade.php ENDPATH**/ ?>