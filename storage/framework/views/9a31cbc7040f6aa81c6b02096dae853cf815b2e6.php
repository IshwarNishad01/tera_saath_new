<div class="card">
    ...
    <div class="card-body">
      ...
      <!--         <td><?php echo e($career->start); ?></td>
              ...
              <td class="text-right">
                  <a href="javascript:void(0);" class="btn btn-soft-info btn-icon btn-circle btn-sm" onclick="career_edit_modal('<?php echo e($career->id); ?>');" title="<?php echo e(translate('Edit')); ?>">
...
<?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/frontend/member/profile/career/index.blade.php ENDPATH**/ ?>