					...
					<table class="table table-striped aiz-table">
						...
						<tbody>
							<tr>
								...
								<td>7.2 or 7.3</td>
								<td>
									<?php if(floatval(phpversion()) >= 7.2 && floatval(phpversion()) < 7.4): ?>
					...
					<table class="table table-striped aiz-table">
						...
						<tbody>
							...
							<tr>
								...
								<td>120+</td>
								<td>
									<?php if(ini_get('max_execution_time') == -1 || ini_get('max_execution_time') >= 120): ?>
										<i class="las la-check text-success"></i>
									<?php else: ?>
										<i class="las la-times text-danger"></i>
									<?php endif; ?>
							...
							<tr>
								...
								<td>256M+</td>
								<td>
									<?php if(ini_get('memory_limit') == -1 || str_replace(['M','G'],"", ini_get('memory_limit')) >= 256): ?>
										<i class="las la-check text-success"></i>
									<?php else: ?>
										<i class="las la-times text-danger"></i>
									<?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/759065.cloudwaysapps.com/jrquzkdxdm/public_html/resources/views/admin/system/server_status.blade.php ENDPATH**/ ?>