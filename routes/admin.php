...
Route::get('/parichay', 'ParichayController@admin_parichay')->name('admin.parichay');
Route::get('/parichay-view/{id}', 'ParichayController@parichayview_details')->name('parichay-view/id');

// Route::get('/parichayview/{mid}', ParichayController::class, 'parichayview_details')->name('parichayview/mid');
// Route::get('/form-view/{id}', [InfoUserController::class, 'form_view_details'])->name('form-view/id');
...
Route::resource('profile','ProfileController');
    ...
    Route::get('/reporte/destroy/{id}','ReportedUserController@destroy')->name('report_destrot.destroy');
